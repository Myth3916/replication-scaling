...
### 2. Схема разбиения для таблиц

![Схема разбиения](screenshots/СхемаРазбиенияТаблиц.png)
...
4. Запрашивает профильные данные из `users_profile` + `users_shard_ru`
5. Агрегирует результат и возвращает клиенту
